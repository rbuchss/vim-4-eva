...
function M.setup(config)
  ...
  require('vim_4_eva.plugin.settings.conform').setup(config)
  ...
  require('vim_4_eva.plugin.settings.markdown-preview').setup(config)
  require('vim_4_eva.plugin.settings.obsidian').setup(config)
